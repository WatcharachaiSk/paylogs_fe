...
export default function SidebarToggleLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div>
      ...
      <button onClick={() => setSidebarOpen(true)} type="button" className=" inline-flex items-center p-2 mt-2 ms-3 text-sm text-gray-500 rounded-lg hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200">
      ...
      >
        <div className="h-full px-3 py-4 overflow-y-auto">
          ...
          <ul className="space-y-2 font-medium mt-4">
            <li>
              <Link href="/" onClick={() => setSidebarOpen(false)} className="flex items-center p-2 hover:bg-gray-100 rounded-lg">
                🏠 <span className="ms-3">Home</span>
              </Link>
            </li>
            <li>
              <Link onClick={() => setSidebarOpen(false)} href="/dashboard" className="flex items-center p-2 hover:bg-gray-100 rounded-lg">
